...
void system_init(void)
{
	...
	gpio_set_pin_direction(BOOT_TXD,
	                       // <y> Pin direction
	                       // <id> pad_direction
	...
	gpio_set_pin_pull_mode(BOOT_TXD,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(BOOT_TXD,
	                      // <y> Pin function
	                      // <id> pad_function
	...
	gpio_set_pin_direction(BOOT_RXD,
	                       // <y> Pin direction
	                       // <id> pad_direction
	                       // <GPIO_DIRECTION_OFF"> Off
	                       // <GPIO_DIRECTION_IN"> In
	...
	gpio_set_pin_pull_mode(BOOT_RXD,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(BOOT_RXD,
	                      // <y> Pin function
	                      // <id> pad_function
	                      // <i> Auto : use driver pinmux if signal is imported by driver, else turn off function
	                      // <GPIO_PIN_FUNCTION_OFF"> Auto
